...
const ProductDisplayPage = ({ params: paramsPromise }) => {
  const params = React.use(paramsPromise)
  const productParam = params.product
  const productId = productParam?.split("-")?.slice(-1)[0]
  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="keywords" content={`${data.name}, ${data.category[0].name}, ${data.subCategory[0].name}`} />

...
// function BrandSummary({ brandStats }) {
//   if (!brandStats.length) return null

//   return (
//     <div className="mb-8 bg-white rounded-lg shadow-md p-6">
//       <h2 className="text-2xl font-bold text-pink-600 mb-4 text-center">
//         Shop by Individual Brand
//       </h2>
//       <p className="text-center text-gray-600 mb-6">
//         Click on any brand to see their complete product catalog with prices
//       </p>

//       <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
//         {brandStats.map((brand) => {
//           const productCount = brand.metrics?.totalProducts || 0
//           const avgPriceDisplay = brand.metrics?.avgSellingPrice
...
//                 <p className="font-semibold text-pink-600">Avg: {avgPriceDisplay}</p>
//               </div>
//             </Link>
//           )
//         })}
...
//           <div>
//             <span className="font-medium text-pink-600">{brandStats.length}</span>{' '}
//             Total Brands
//           </div>
//           <div>
//             <span className="font-medium text-pink-600">
//               {brandStats.reduce(
//                 (sum, brand) => sum + (brand.metrics?.totalProducts || 0),
//                 0
//               )}
//             </span>{' '}
...
//     }. Categories: ${
//       subCategoryNames.length ? subCategoryNames.join(', ') : 'foundations, lip makeup, eye makeup, face makeup'

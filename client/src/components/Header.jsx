            ...
            <nav className="bg-black text-white px-2 sm:px-4">
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        href="/orders"
                        className="
                        text-base sm:text-lg xs:text-xs 
                        px-2
                        hover:transition-colors duration-300
                        underline-offset-8
                        no-underline hover:underline hover:text-pink-300
                    ...
                    <div className="hidden lg:flex items-center gap-2">
                        {user?._id ? (
                            ...
                            //  This is the best approach for internal navigation  not onClick
                            <Link href="/login" className='text-lg px-2 hover:text-pink-400 transition-colors'>
                                Login
                            </Link>
                        )}
                        <button
